...
from embed_toolkit import DatasetGraph, Exam, MammogramImage, Patient, RegionOfInterest
from embed_toolkit.core.source import Issue, IssueSeverity
...
def test_shared_descendant_is_validated_once():
    from embed_toolkit import Finding, Laterality, Procedure, ProcedureIdentity
    exam = Exam("A")
